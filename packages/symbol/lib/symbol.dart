...
const SymbolCombinations = <PropheciesRange, SymbolCombination>{
  ...
  PropheciesRange(
    ...
    digit: 6,
    mineral: Gem.Garnet,
    colors: ["white", "lightred", "lightyellow"],
    tarrot: TarrotMajor.TheChariot,
    name: "orchids",
  ),
  PropheciesRange(
  ...
  PropheciesRange(
    ...
    digit: 7,
    mineral: Gem.Citrine,
    colors: ["yellow", "lightorange", "white"],
    tarrot: TarrotMajor.Judgment,
    name: "yellow_dragon",
  ),
  PropheciesRange(
  ...
  PropheciesRange(
    ...
    colors: ["deeporange", "lightpurple", "orange"],
    tarrot: TarrotMajor.Temperance,
    name: "squirrel",
  ),
  PropheciesRange(
  ...
  PropheciesRange(
    ...
    digit: 8,
    mineral: Gem.Diamond,
    colors: ["black", "deeporange", "deepblue"],
    tarrot: TarrotMajor.Lust,
    name: "gorilla",
  ),
  PropheciesRange(
  ...
  PropheciesRange(
    ...
    digit: 3,
    mineral: Gem.BlueTourmaline,
    colors: ["lightyellow", "lightred", "purple"],
    tarrot: TarrotMajor.TheMagician,
    name: "artist",
  ),
  PropheciesRange(
  ...
  PropheciesRange(
    ...
    digit: 8,
    mineral: Gem.Alexandrite,
    colors: ["white", "lightorange", "black"],
    tarrot: TarrotMajor.Justice,
    name: "swam",
  ),
  PropheciesRange(
  ...
  PropheciesRange(
    ...
    colors: ["deeppink", "deepblue", "purple"],
    tarrot: TarrotMajor.TheFool,
    name: "joker",
  ),
  PropheciesRange(
